...
#define MSB_FIRST             0u    /* big endian bit order */
#define LSB_FIRST             1u    /* little endian bit order */
...
#define CPU_BIT_ORDER    LSB_FIRST        /*little endian bit order*/
#define CPU_BYTE_ORDER   LOW_BYTE_FIRST   /*little endian byte order*/
